...
const studies = [
  ...
  },
  {
    ...
    badge: "🎵",
    badgeColor: "#FF6B6B",
    type: "מחקר עיצוב רב-מרכזי",
    title: "Music Intervention and Cognitive Decline in Older Adults",
    journal: "Journal of Alzheimer's Disease · 2021",
    summary: `מחקר שבחן השפעת התערבות מוזיקלית (השלמת מילים בשירים מוכרים) על 180 מבוגרים עם ירידה קוגניטיבית קלה. הקבוצה שקיבלה את ההתערבות הראתה שמירה טובה יותר של זיכרון אפיזודי ושיפור בהנאה ואיכות חיים לאחר 6 חודשים.`,
    stats: [
      { num: "180", label: "משתתפים" },
      { num: "6 חודשים", label: "מעקב" },
      { num: "↑", label: "זיכרון אפיזודי" },
    ],
    relevance: "משחק ׳שירים ישנים׳ ב-CogniPlay מבוסס ישירות על גישה זו — השלמת מילים לשירים ישראליים ועולמיים מוכרים.",
    link: "https://www.j-alz.com",
  },
];
  ...
  return (
    <>
      ...
      <div className="hero-research">
        <div className="star-tag">🔬 מבוסס מחקר מדעי בלבד</div>
        <h1>הבסיס המדעי של CogniPlay</h1>
        <p>
          כל תכונה ב-CogniPlay נבנתה על בסיס מחקרים peer-reviewed
          מהכתבים המדעיים המובילים בעולם.
        </p>
      </div>
