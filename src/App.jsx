// CogniPlay v5.5 — songs + animals fixed
...
he:[
  ...
  {l:"מי ייתן והיינו שוב ___",a:"בירושלים",o:["בירושלים","ביחד","בשלום","בארץ"],t:"מי ייתן",e:"🌟"},
...
const ANIMALS_HE = [
  {img:"https://images.pexels.com/photos/1108099/pexels-photo-1108099.jpeg?auto=compress&w=400",emoji:"🐕",name:"כלב",opts:["כלב","חתול","שועל","ארנב"]},
  {img:"https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg?auto=compress&w=400",emoji:"🐈",name:"חתול",opts:["חתול","כלב","ארנב","שועל"]},
  {img:"https://images.pexels.com/photos/66898/elephant-cub-elephants-baby-66898.jpeg?auto=compress&w=400",emoji:"🐘",name:"פיל",opts:["פיל","ג'ירפה","קרנף","היפופוטם"]},
  {img:"https://images.pexels.com/photos/797643/pexels-photo-797643.jpeg?auto=compress&w=400",emoji:"🦒",name:"ג'ירפה",opts:["ג'ירפה","פיל","גמל","זברה"]},
  {img:"https://images.pexels.com/photos/2220336/pexels-photo-2220336.jpeg?auto=compress&w=400",emoji:"🦁",name:"אריה",opts:["אריה","נמר","זאב","דוב"]},
  {img:"https://images.pexels.com/photos/3608263/pexels-photo-3608263.jpeg?auto=compress&w=400",emoji:"🐼",name:"פנדה",opts:["פנדה","דוב","קואלה","ארנב"]},
  {img:"https://images.pexels.com/photos/326012/pexels-photo-326012.jpeg?auto=compress&w=400",emoji:"🐇",name:"ארנב",opts:["ארנב","חתול","עכבר","שועל"]},
  {img:"https://images.pexels.com/photos/1571442/pexels-photo-1571442.jpeg?auto=compress&w=400",emoji:"🦊",name:"שועל",opts:["שועל","זאב","כלב","חתול"]},
  {img:"https://images.pexels.com/photos/1618606/pexels-photo-1618606.jpeg?auto=compress&w=400",emoji:"🐢",name:"צב",opts:["צב","צפרדע","נחש","לטאה"]},
  {img:"https://images.pexels.com/photos/133459/pexels-photo-133459.jpeg?auto=compress&w=400",emoji:"🦋",name:"פרפר",opts:["פרפר","דבורה","זבוב","יתוש"]},
  {img:"https://images.pexels.com/photos/47547/squirrel-animal-cute-rodents-47547.jpeg?auto=compress&w=400",emoji:"🐿️",name:"סנאי",opts:["סנאי","עכבר","ארנב","חולד"]},
  {img:"https://images.pexels.com/photos/1350593/pexels-photo-1350593.jpeg?auto=compress&w=400",emoji:"🐄",name:"פרה",opts:["פרה","סוס","חמור","עז"]},
];
const ANIMALS_EN = [
